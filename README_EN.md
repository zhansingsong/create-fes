...
- Usage
  ...
  ```
  And then type `mock` command to get the corresponding mock data in dev mode.
  ```bash
  $ mock
  Mock Data:
...
_Note: The reference to the image must be relative to the entry page. The **absolute path** way is recommended._
