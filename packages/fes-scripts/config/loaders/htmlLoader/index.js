...
module.exports = function(content) {
  const self = this;
	...
	if (config.exportAsDefault) {
 	...
 	var result = exportsString + content.replace(/xxxHTMLLINKxxx[0-9\.]+xxx/g, function(match) {
    ...
    fes.outputFileSync(path.join(process.cwd(), 'config', 'media.json'),  JSON.stringify(mediaSource));
