...
// paths
const viewsTemp = resolve(paths.appNodeModules, 'fes-scripts', 'config', '.temp');
 ...
 */
const validateRouterConfig = (routerConfig = getDefaultRouterConfig()) => {
...
module.exports = (app, routerConfig, proxy = {}) => {
  // proxy
  try {
  ...
  app.on('qrcode-and-open-browser', (port, config) => {
